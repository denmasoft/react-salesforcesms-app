    ...
    render() {
        return (<div className="nav-bar">
            <div className="nav-block w-clearfix">
                ...
                <div className="app-tittle">Inbox</div>
                <div data-collapse="medium" data-animation="over-right" data-duration="400" className="navbar w-nav">
                    <div className="w-container">
                        ...
                        <nav role="navigation" className="nav-menu w-nav-menu">
                            ...
                            <a href="#" onClick={()=>this.goToUrl('/inbox')} className="nav-link w-nav-link w--current">Inbox</a>
                            <a href="#" onClick={()=>this.goToUrl('/sent')} className="nav-link w-nav-link">Sent</a>
