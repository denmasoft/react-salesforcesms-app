...
gulp.task('generate-service-worker', function(callback) {
  ...
  var rootDir = 'build';
  var version, i = process.argv.indexOf("--version");
  if(i>-1) {
    version = process.argv[i+1];
  }
  swPrecache.write(path.join(rootDir, 'service-worker.js'), {
    staticFileGlobs: [rootDir + '/**/*.{css,eot,gif,html,ico,js,json,jpg,jpeg,png,svg,ttf,woff,woff2}'],
    stripPrefix: rootDir,
    ignoreUrlParametersMatching: [/^homescreen/],
    cacheId: version,
